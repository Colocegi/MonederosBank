public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        // 1. Simular la creación de un Cliente (Implementación de ICliente)
        // Necesitas una instancia de Cliente para cumplir con el constructor de Cuenta.

        // Creamos la Cuenta Corriente primero
        CuentaCorriente cc = new CuentaCorriente(1001, null, 500.0);
        Cliente cliente1 = new Cliente(1, "Ana", "García", cc);
        cc = new CuentaCorriente(1001, cliente1, 500.0); // Se recrea con el ICliente/Cliente correcto

        // Creamos la Cuenta de Ahorro
        CuentaAhorro ca = new CuentaAhorro(2002, null, 2.5);
        Cliente cliente2 = new Cliente(2, "Juan", "Pérez", ca);
        ca = new CuentaAhorro(2002, cliente2, 2.5); // Se recrea con el ICliente/Cliente correcto

        // --- PRUEBAS DE OPERACIONES ---

        // 2. Acreditación (Método público en Cuenta)
        ...
        // 3. Débito Exitoso (Lógica de CuentaAhorro)
        ...
        // 4. Débito Fallido (Lógica de CuentaAhorro - Sin sobregiro)
        System.out.println("\n--- 3. Prueba de Débito Ahorro (FALLO SRP) ---");
        intentarDebito(ca, 600.0); // Debería lanzar FalloTransaccionException

        // 5. Débito con Sobregiro (Lógica de CuentaCorriente)
        ...
        // 6. Débito Fallido (Lógica de CuentaCorriente - Excede límite)
    ...
    /**
     * Método auxiliar que simula el controlador/Banco manejando el débito y la excepción.
    ...
    public static void intentarDebito(Cuenta cuenta, double monto) {
        try {
            ...
            // Si debitar() es protected, tendrías que exponer un método public en Cuenta, por ejemplo:
